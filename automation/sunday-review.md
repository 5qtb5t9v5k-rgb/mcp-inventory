...
**Ajastus:** Kairos cron, sun. 19:00
**Connectorit:** MyHealthMCP, MyTodoist, MyFinance
...
Liitä yllä oleva prompti tavalliseen claude.ai-keskusteluun, jossa kaikki kolme connectoria ovat käytössä. Hyvä testihetki on sunnuntai-iltapäivä, koska aikajakso vastaa silloin tarkoitusta.

## Tunnetut rajoitteet

- **Finance vaatii tuoreen CSV:n.** Jos `upload.sh` jää ajamatta, talous-osio raportoi vanhentunutta dataa. Aja CSV-upload sunnuntain aikana ennen ajastusta.
- **Strava-kuorma vs. mileage.** "Kuorma" tulkitaan tässä tunteina/kilometreinä. Jos haluat oikean training load -mittarin, vaihda promptiin `strava_get_athlete_stats` ja vertaile recent_run_totals / recent_ride_totals.
